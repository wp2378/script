...
<body class="col-12">
	...
	onsubmit="handler3()">
		...
		<div class="text-end">
			<input type="submit" value="제출" class="btn bth-primary"/>
			<button type="submit" class="btn bth-primary">제출</button>
			<input type="submit" value="제출" class="btn bth-primary"/>
			<button type="button" class="btn bth-primary">제출안됨</button>
		</div>
	</form>
