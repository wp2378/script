...
<script type="text/javascript">
	/*
		엘리먼트 선택하기
			...
			HtmlCollection	getElementsByTagName(tagName)
			HtmlCollection	getElementsByClassName(className)
			(NodeList = Htmlcollection)
	
			Element			querySelector(css선택자)
			HTMLCollection	querySelectorAll(css선택자)
	...
	*/
	...
	function handler6() {
		...
		// p 엘리먼트 5개가 선택된다.
		let nodelist1 = document.querySelectorAll("#intro");
		// p 엘리먼트 2개가 선택된다.
