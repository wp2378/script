...
--%>
		<form>
			<div class="form-group">
				<label class="form-lavel">카테고리</label>
			...
			<div class="form-group">
				<label class="form-lavel">메모</label>
				<textarea class="form-control" rows="4" name="memo">좋은 제품입니다.</textarea>
			</div>
			<div class="form-group">
				<label class="form-label">상태</label>
				<div class="form-check">
					<input type="radio" class="form-check" id="statue-300" name="status" value="300" />
					<label class="form=check-label">입고예정</label> 
				</div>
				<div class="form-check">
					<input type="radio" class="form-check" id="statue-301" name="status" value="301" checked/>
					<label class="form=check-label">판매중</label> 
				</div>
				<div class="form-check">
					<input type="radio" class="form-check" id="statue-302" name="status" value="302" />
...
<script type="text/javascript">
	...
	*/
	...
	let el6 = docment.querySelector("input[name=status]:checked")
	let valuse6 = el6.value;
	console.log(value6);
